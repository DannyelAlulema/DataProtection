    ...
    <div class="container">
        ...
        <ul class="list">
            ...
            <li>
                ...
                publicaciones y/o anuncios de su interés; (iii) Generar estudios de mercado y encuestas para conocer su
                opinión respecto a nuestros productos y/o servicios y cualquier proceso en función de mercadeo o venta
                que este previamente autorizada por el titular; iv) Participar en campañas y beneficios de fidelización;
        ...
        <ul class="list">
            ...
            <li>
                ...
                inequívoca, por el que el titular de los datos personales autoriza al responsable del tratamiento de los
                datos personales a tratar los mismos.
            </li>
            <li>
                Base De Datos: Conjunto estructurado de datos cualquiera que fuera la forma, modalidad
                de creación, almacenamiento, organización, tipo de soporte, tratamiento, procesamiento, localización o
            ...
            <li>
                ...
                relativos al origen racial o étnico, la filiación política, las convicciones religiosas o filosóficas,
                la ideología, así como los datos relativos a la salud, la orientación sexual y los datos biométricos y
                genéticos.
            </li>
            <li>
                Derechos del titular: Son los correspondientes a la posibilidad de solicitar el
                acceso, eliminación, rectificación y actualización, oposición, anulación, limitación del tratamiento que
            ...
            <li>
                ...
                Personales, que podrá, de manera no exclusiva, proporcionar certificaciones en materia de protección de
                datos personales.
            </li>
            <li>
                Responsable de los datos personales: Persona natural o jurídica, pública o privada,
                que por sí misma o en asociación con otros, decida sobre la finalidad y/o el tratamiento de los datos
                personales.
            </li>
            <li>
                ...
                personales realizada a una persona distinta al titular, responsable o encargado del tratamiento de datos
            ...
            <li>
                ...
                personales ya sean físicas o automatizadas que permitan, entre otras cosas, recoger, recopilar, obtener,
        ...
        <p class="text">
            <b>4.2. Acceso:</b> El titular puede acceder a sus datos presentados para su tratamiento sin necesidad de
            tener que
            presentar ningún tipo de justificación para el efecto. Toda solicitud para estos efectos será respondida por
        ...
        <p class="text">
            ...
            costo, de manera pormenorizada y detallada, los respectivos datos personales tratados, a través de cualquier
            medio de comunicación, incluyendo los electrónicos que permitan el acceso directo del titular.
        </p>
        <p class="text">
            <b>4.3. Rectificación </b>y actualización: Todo titular de datos personales tiene frente a la Compañía la
            posibilidad de solicitar la corrección o actualización de su información frente a datos inexactos o
            incompletos y presentar reclamos, no solo frente a la entidad sino ante la autoridad de protección de datos
            personales.
        </p>
        <p class="text">
        ...
        <p class="text">
            <b>4.5. Oposición.</b> El titular puede oponerse o negarse al tratamiento de sus datos personales cuando los
            mismos
            sean utilizados para la realización de actividades de marketing o mercadeo por parte de la Compañía, la
            oposición no afecte derechos y libertades de terceros y no haya para la Compañía una obligación legal o una
            situación que se fundamente en el interés legítimo para realizar el tratamiento de los datos
        </p>
        <p class="text">
            Los derechos de rectificación, actualización, eliminación, oposición, anulación y portabilidad de los datos
            personales no podrán ser ejercidos cuando se presenten los casos establecidos en el artículo 18 de la Ley
            Orgánica de Protección de Datos Personales.
        </p>
        <p class="text">
            En caso que la Compañía actúe como encargado del tratamiento de datos personales, el titular debe realizar
        ...
        <p class="text">
            En función de la anterior usted como titular o legitimado debe enviar un email a [correo electrónico para el
            ejercicio de derechos] indicando su petición o consulta, teniendo en cuenta las siguientes consideraciones:
        </p>
        <p class="text">
            La solicitud debe estar dirigida a la Compañía según la denominación indicada en el numeral 1 de la presente
        ...
        <ul class="list">
            ...
            <li>En caso que el Titular actué mediante representación o apoderado deberá acreditarse tal calidad mediante
                poder especial. </li>
            <li>En caso de actuar por medio de otra persona, se deberá aportar poder y/o autorización debidamente
                conferida por el Titular, y se deberá manifestar de manera clara y expresa el motivo de la solicitud y
                el derecho que le asiste.</li>
            <li>Para el caso de los menores de quince (15) años de edad se solicitará a su representante o acudiente la
        ...
        <p class="text">
            ...
            previamente mencionados con relación a la protección de los datos se atenderán en el término de diez (10)
            días. En caso que el requerimiento estuviere incompleto, la Compañía deberá comunicar este evento al Titular
            para que este sea completado en el término de dos (2) días hábiles. En caso de no realizar esta acción, se
        ...
        <p class="text">La Compañía como responsable o encargado del tratamiento de información, sin menoscabo de las
        ...
        <ul class="list">
            ...
            <li>Atender los requerimientos de los titulare de datos personales en los términos legales previstos en la
                normativa ecuatoriana. </li>
            <li>Informar a la autoridad de protección de datos personales nacional cuando se presenten vulneraciones a
        ...
        <ol class="list lower-alpha-list">
            ...
            <li>En cumplimiento de una obligación realizadas en interés público, sujeto al cumplimiento de los
                estándares internacionales de derechos humanos aplicables a la materia, principios de la Ley Orgánica de
        ...
        <p class="text">
            El consentimiento del titular para para tratar sus datos personales, será válido cuando el consentimiento
            sea:
        </p>
        <ol class="list lower-alpha-list">
        ...
        <p class="text">
            ...
            personales. La Compañía no es responsable de la obtención de todo tipo de autorización para tratamiento de
        ...
        <ol class="list lower-alpha-list">
            <li>Pueden ser tratados aquellos que sean estrictamente necesarios para la realización de la finalidad.</li>
            <li>Se debe garantizar al titular la transparencia del tratamiento</li>
            <li>La Autoridad de Protección de Datos, puede requerir a la Compañía un informe a fin de verificar si no
                hay amenazas concretas a las expectativas legítimas de los titulares y sus derechos.</li>
        </ol>

        <h2 class="section-header">9. POLITICAS INTERNAS EFECTIVAS Y HERRAMIENTAS PARA LA SEGURIDAD DE LA INFORMACION:
        </h2>
        <p class="text">
            ...
            personal calificado en función de su rol y desempeño dentro de la Compañía, que mantenemos una estructura
            administrativa y tecnológica proporcional al tamaño empresarial y hemos adoptado mecanismos internos para
            poner en práctica estas políticas incluyendo herramientas de implementación, entrenamiento y programas de
        ...
        <p class="text">
            La Compañía podrá transferir o comunicar los datos personales de los titulares a terceros cuando se realice
            para el cumplimiento de fines directamente relacionados con sus operaciones, y cuando la transferencia se
            encuentre configurada dentro de una de las causales de legitimidad establecidas en la legislación nacional,
            además, con el consentimiento del Titular.
        </p>

        <h2 class="section-header">11. VIGENCIA DE LAS BASES DE DATOS.</h2>
        <p class="text">
            [Nombre de la Empresa], tratará los datos personales del titular durante el tiempo necesario para cumplir
        ...
        <p class="text">
            Cuando la Compañía tenga conocimiento de una violación de seguridad de datos personales tanto presunta como
            real, deberá realizar una investigación interna y tomar las medidas correctivas adecuadas a tiempo. Cuando
            exista un riesgo para los derechos y las libertades de los titulares, la Compañía debe notificar a la
            autoridad de protección de datos personales nacional, los responsables y titulares de los datos personales
